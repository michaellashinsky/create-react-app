...
var getCustomConfig = require('./getCustomConfig');
...
var publicPath = ensureSlash(homepagePathname, homepagePathname !== '');
...
module.exports = {
    ...
    module: {
        ...
        loaders: [
            ...
            {
                test: /\.css$/,
                loader: ExtractTextPlugin.extract.apply(null, customConfig.values.STYLES_CSS_MODULES ? ['style', 'css?modules&importLoaders=1', 'postcss'] : ['style', 'css?importLoaders=1', 'postcss'])
